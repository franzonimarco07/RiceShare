...
const appearance = {
  ...
  elements: {
    ...
    identityPreviewText:    'rs-clerk-identity-text',
    /* errors */
...
.rs-topbar-comment { font-size: 11px; color: #2e2e2e; font-style: italic; font-family: 'IBM Plex Mono', monospace; }
.rs-center {
  flex: 1;
  display: flex;
  align-items: center;
...
.rs-clerk-alert {
  background: #a0585808 !important;
  border: 1px solid #a0585844 !important;
  border-radius: 0 !important;
}
.rs-clerk-alert-text {
  color: #c07070 !important;
...
.rs-clerk-otp-input:focus {
  border-color: #f2f2f0 !important;
  box-shadow: none !important;
}
/* nasconde il logo Clerk */
        ...
        <div className="rs-content">
          ...
          <div className="rs-center">
            <div style={{ width: '100%', maxWidth: 400 }}>
              <div className="rs-pre">// sign in</div>
              <div className="rs-title">Login</div>
              <SignIn
